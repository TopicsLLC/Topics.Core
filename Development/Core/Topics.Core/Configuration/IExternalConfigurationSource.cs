...
{
    public interface IExternalConfigurationSourceFactory
    {
        IExternalConfigurationSource Create(string ExternalConfigurationSource);
    }

    public interface IExternalConfigurationSource
    {
        Dictionary<string, string> ReadSource();
    }
}
